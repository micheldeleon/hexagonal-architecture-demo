...
import com.tutorneo.adapters.in.api.dto.CreateTournamentRequest;
import com.tutorneo.adapters.in.api.dto.RegisterToTournamentRequest;
import com.tutorneo.adapters.in.api.dto.RemoveTeamFromTournamentRequest;
import com.tutorneo.adapters.in.api.dto.RunnerRegistrationRequest;
import com.tutorneo.adapters.in.api.dto.TournamentResponse;
import com.tutorneo.adapters.in.api.dto.TournamentSummaryResponse;
import com.tutorneo.adapters.in.api.dto.UpdateTournamentRequest;
import com.tutorneo.adapters.in.api.mappers.TournamentMapper;
import com.tutorneo.adapters.in.api.mappers.TournamentSummaryMapper;
import com.tutorneo.adapters.in.api.dto.RegisterTeamRequest;
import com.tutorneo.adapters.in.api.dto.TournamentMatchResponse;
import com.tutorneo.adapters.in.api.dto.RaceResultRequest;
import com.tutorneo.adapters.in.api.dto.RaceResultResponse;
import com.tutorneo.adapters.in.api.dto.LeagueMatchResultRequest;
import com.tutorneo.adapters.in.api.dto.LeagueStandingResponse;
import com.tutorneo.adapters.in.api.dto.CancelTournamentResponse;
import com.tutorneo.adapters.in.api.dto.StartTournamentResponse;
import com.tutorneo.adapters.in.api.dto.TeamSummaryDto;
import com.tutorneo.adapters.in.api.dto.LeaveTournamentRequest;
import com.tutorneo.core.application.service.ImageUploadService;
...
import com.tutorneo.core.ports.in.GenerateEliminationFixturePort;
import com.tutorneo.core.ports.in.GenerateLeagueFixturePort;
import com.tutorneo.core.ports.in.GetFixturePort;
...
public class TournamentController {
    ...
    public ResponseEntity<?> startTournament(@PathVariable Long id, Authentication authentication) {
        try {
            String userEmail = authentication != null ? authentication.getName() : null;
            var result = startTournamentPort.start(id, userEmail);
            String message = String.format(
                    "¡El torneo ha sido iniciado por %s! Cuenta con %d participantes. Revisa el fixture para conocer los horarios.",
                    result.startedByName(),
                    result.participantsCount());
            return ResponseEntity.ok(new StartTournamentResponse(
                    id,
                    TournamentStatus.INICIADO,
                    result.startedAt(),
                    result.startedByName(),
                    result.participantsCount(),
                    message));
    ...
    public ResponseEntity<?> reportMatchResult(@PathVariable Long tournamentId,
            ...
            @Valid @RequestBody com.tutorneo.adapters.in.api.dto.ReportMatchResultRequest request) {
        try {
